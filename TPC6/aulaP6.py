...
def menu(obras):
    ...
    while opçao != 0:
        print("""Menu:
                ...
                3- Ver lista de tuplos (título, ano), ordenada por ordem alfabetica por título;
                4- Ver lista de tuplos (título, ano), ordenada crescentemente por ano;
                5- Ver obras organizadas pelo seu ano de criação
        ...
        opçao = int(input("Escolha uma das opções do menu:"))

        if opçao==1:
            print("O nº de obras é ", tamanhoObras(obras))
